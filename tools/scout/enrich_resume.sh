...
bash alert.sh "remlab: обогащение возобновлено и завершено (проба 40 + полный хвост)" || true   # код alert.sh теперь честный (04.09) — успех скрипта от доставки не зависит
