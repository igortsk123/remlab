#!/usr/bin/env python3
"""Страница ремонтов: пары «оригинал → кандидат после ножей». АРХИВ.

Ремонт отменён владельцем 01.09 (ADR-0143), копии убраны в `~/scout-scenes/mesh-repairs-parked/`
— скрипт оставлен как история, в конвейере не вызывается и найдёт пустоту.
"""
import glob
import html
import json
