...
TEMPLATES = {
    ...
    'диван + 4 кресла (32+ м²)': {'диван': 220, 'кресло': 95, 'кресло 2': 95,
                                  'кресло 3': 95, 'кресло 4': 95, 'столик': 110,
                                  'ковёр': 290},
    'угловой + 2 кресла (24+ м²)': {'диван': 260, 'кресло': 85, 'кресло 2': 85,
                                    'столик': 90, 'ковёр': 290},
    '2 кресла без дивана (12+ м²)': {'кресло': 76, 'кресло 2': 76, 'столик': 90,
                                     'ковёр': 160},
    '2 дивана П-стык (45+ м²)': {'диван': 230, 'диван 2': 230, 'кресло': 95,
                                 'кресло 2': 95, 'столик': 110, 'ковёр': 290},
    '2 дивана визави (32+ м²)': {'диван': 220, 'диван 2': 220, 'столик': 110,
                                 'ковёр': 290},
    'U-композиция (40+ м²)': {'диван': 220, 'кресло': 95, 'кресло 2': 95,
                              'кресло 3': 95, 'кресло 4': 95, 'столик': 90,
                              'приставной': 45, 'ковёр': 290},
    'столовая 2 стула (15+ м²)': {'стол обеденный': 90, 'стул': 45, 'стул 2': 45},
    'столовая 4 стула (25+ м²)': {'стол обеденный': 140, 'стул': 45, 'стул 2': 45,
                                  'стул 3': 45, 'стул 4': 45},
    'столовая 6 стульев (45+ м²)': {'стол обеденный': 160, 'стул': 45, 'стул 2': 45,
    ...
    'стеллаж-стена (10+ м²)': {'стеллаж': 80, 'комод': 120, 'кашпо': 40},
