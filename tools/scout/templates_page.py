...
card('storage_wall', 'Стеллаж-стена: хранение в линию + растение (v2.4)',
     ...
     'ТВ-стене (межзонный штраф).', gross_m2=25)

card('media_flanks', 'Медиа-зона: носитель + растения по флангам (v2.7/v2.8)',
     ...
     'межзонной связи (соосность с главным посадочным). По флангам — только '
     'растения/декор: торшер по интернет-своду живёт у ПОСАДКИ (правка владельца), '
     'мелкая лампа — НА тумбе (её ставит рендер).', gross_m2=22)
...
— без носителя ТВ блок ориентируется на камин; <b>узкая комната, тесно флангам</b> — кресла столбиком с одного бока (вариант выбирается автоматически); <b>межзонный слой</b> — прицел экрана
