...
# Синхронный путь идёт через Vercel-шлюз (ADR-0181); вернуть --batch — когда владелец пополнит
...
# ОБЫЧНЫЙ шаг, не за openai.off: канал — Vercel AI Gateway (ADR-0181), рубильник OpenAI его
