# Извлечено из Holodeck (allenai/Holodeck, ai2holodeck/generation/floor_objects.py)
# Copyright Allen Institute for AI. Apache License 2.0.
# Взяты только DFS_Solver_Floor + SolutionFound (без ML/LLM/MILP/визуализации).
