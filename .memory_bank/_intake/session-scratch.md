...
- Внешний аудит правил (08.08): 3 «P0» оказались неточны (код уже SOFT/subtype-aware — дефект выгрузки: пустая жёсткость + docstring 100 см; оба чинены). Принят бэклог W1–W7 в MASTER-zones-first (классы правил, эргономика не от площади, size-bands→приоры, provenance с commit-SHA, симметрия/balance нижним ярусом, articulation, constraint-IR). Страница-обоснование исправлена: ProcTHOR полный список полей, 3D-FRONT — синтетика проф. дизайна (не «реальные»), Infinigen переоценён вверх.
