...
- **Стадия:** концепция **v0.4 «Смета-first»** (ADR-0016). **Ядро сметы М1 в проде** (вход А
  ...
  (Этап 1 калькуляторы → /calc/[kind], Этап 2 ремонт → /calc/remont). Дальше: автопилот на все
  кампании (М4), М5 (виз./мебель — legacy AI-флоу `/p/*` жив). Прежние пивоты: v0.3 ADR-0014.
