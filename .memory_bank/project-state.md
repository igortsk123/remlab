...
спящих 3. 21.08 отработан аудит Юли (ADR-0115): 13/15 замечаний принято, каскад «камин+ТВ»
(side_by_side → смежные стены → ТВ над камином), «между окон» реализована честно, ТВ-референс
на карточках; №13/№35 отклонены с пруфом (решение владельца). Сводка — `core/layout.md`.
