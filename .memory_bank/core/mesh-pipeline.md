...
**Выкатка на ноды — ADR-0154/0157:** слой поверх боевого образа
(`tools/scout/salad/Dockerfile.code`) + НОВАЯ группа (PATCH образа молчит). Общая медленность
закачки НЕ лечится пересадкой, а исключения группы сбрасывает только новая версия контейнера.
