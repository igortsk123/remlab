...
- **Сеты**: v2 «как дизайнер» (ADR-0044/0046). С 08-05 — «сперва допустимость, потом красота»
  ...
  (было 107+88). Планы в архиве: sets-feasibility-first, catalog-enrichment-pipeline.
- **Стили** (ADR-0047/0048, план `sets-style-v3` в архиве): 6 паспортов + стиль-скор → sets3.json
