...
- **Сеты**: v1 (21 шт., утверждаются владельцем) ЗАМОРОЖЕНЫ в sets.json; v2 «как дизайнер»
  (ADR-0044): капсула стиль/дерево/металл/гамма, акцент-пары, пропорции, CLIP-похожесть,
  alternates + судья gpt-5-mini (7.3/10) → sets2.json; чекпоинт v1-vs-v2 у владельца
  (`sets-compare-v1-v2.html`). План [[sets-compose-v2]].
