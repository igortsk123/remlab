...
`products.cat_role`): 1 931 категория, берём 76 + 3 категории картин/постеров/панно
(112923:4948–4950 → роль «картина», ADR-0078 — wall art в составе; подтянет крон загрузки).
Регекс-view `lr_roles` — историческая, не источник.
