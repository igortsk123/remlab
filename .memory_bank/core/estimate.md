...
`lib/calc/*`, localStorage). UX: проёмы у стены фактом ввода (плитка/краска ADR-0035, обои — в запас);
плитка — размер в СМ, цена за м²/шт/упак; ламинат — за м² (ADR-0030). Хвосты: итог → сопутка →
«найдём дешевле» → виз. Роадмап `calc-materials-roadmap.md`.
