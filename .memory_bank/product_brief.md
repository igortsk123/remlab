...
## Цель / ценность
Быстро дать первую ценность: AI-preview обновлённой комнаты + 3–5 идей + preview товаров и материалов + диапазон бюджета → продать полный **room pack** (полный список товаров и материалов, цены, ссылки, чек-лист, план, PDF).

> Товары (мебель, декор, свет, текстиль) и материалы (краска, обои, напольное покрытие и т.п.) — две разные категории результата; обе присутствуют в free-preview и в paid room pack. Формула Stage 1: **фото → style cards → AI-preview → ограниченный free-результат → paywall → room pack → workspace**.
