...
функции (`lib/estimate/calc.ts`) + golden-тесты. (4) v2 под флагом `CALC_V2` (`lib/calc/flag.ts`,
`?v2=1`); прод-дефолт — прежний калькулятор до К3, где v2 промоутится. (5) Платёж (К5 YooKassa) и
