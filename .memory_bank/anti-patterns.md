...
Секции «Архив уроков…» и «Уроки N–M…» (уроки 1–413 и записи без номера) перенесены 2026-09-05 ДОСЛОВНО в
...
- `lessons/mesh-salad-pool.md` — Меши, Salad, пул нод — записей: 56
- `lessons/catalog-stock.md` — Каталог, фиды, наличие, размеры — записей: 82
- `lessons/layout-solver.md` — Расстановка: зоны, солвер, шаблоны, экзамен — записей: 106
- `lessons/viz-render.md` — Визуализация: depth, fal, панорамы, маски, кадр — записей: 104
- `lessons/demo-planner.md` — Демо-планировщик, кадры демо, витрина/конструктор — записей: 19
- `lessons/devops-deploy.md` — DevOps: docker, exit-fi, деплой, CI, хуки, инструменты — записей: 52
- `lessons/memory-process.md` — Память, процесс, работа с владельцем — записей: 13
- `lessons/estimate-ads-leads.md` — Смета, калькуляторы, Директ, лиды (+ source-KB) — записей: 17
