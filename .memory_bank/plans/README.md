...
|------|----------|--------|---------|---------|
| memory-merge-mltest | Слияние — перенести mltest в репозиторий целиком (код, знания, секреты) и закрыть дыру «не знаю, что у нас есть» | draft | 2026-08-04 | 2026-08-04 |
