...
| stock-check-weekly-unified | Одно правило проверки наличия — раз в неделю для всех; непроверяемым верим Гдеслону | draft | 2026-09-01 | 2026-09-01 |
| mesh-idle-between-batches | Ноды не простаивают между пачками — постобработка уходит с критического пути | in_progress | 2026-09-01 | 2026-09-01 |
