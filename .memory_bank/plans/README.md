...
| mesh-sets-substitution-pipeline | Конвейер «сеты ↔ меши ↔ замена»: пригодность фото, управляемый резерв, точечная пересборка | in_progress | 2026-08-28 | 2026-08-28 |
...
| mask-quality-rgba-contract | Качество вырезки фона → качество мешей: контракт RGBA, гибридная маска, гейт маски | in_progress | 2026-08-28 | 2026-08-28 |
