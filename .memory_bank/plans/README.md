...
| calc-K5-visualization | К5 — Визуализация за 60 ₽ (фото комнаты с выбранными материалами) | draft | 2026-07-12 | 2026-07-12 |
| calc-K4-link-autofill | К4 — Автозаполнение параметров по ссылке на товар | draft | 2026-07-12 | 2026-07-12 |
| calc-K3-result-estimate | К3 — Результат + агрегация по комнатам + мост в смету (промоут v2) | draft | 2026-07-12 | 2026-07-12 |
| calc-K2-material-params | К2 — Параметры материалов (ручной ввод) + полные формулы | draft | 2026-07-12 | 2026-07-12 |
