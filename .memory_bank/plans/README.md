...
|------|----------|--------|---------|---------|
| sets-feasibility-first | Подбор сетов «сперва допустимость, потом красота» — геометрия в ограничения, оценка комплекта целиком | draft | 2026-08-05 | 2026-08-05 |
| catalog-enrichment-pipeline | Конвейер обогащения каталога — три независимых потока, дельта и каскад по стоимости | draft | 2026-08-05 | 2026-08-05 |
