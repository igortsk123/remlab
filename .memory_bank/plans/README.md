...
|------|----------|--------|---------|---------|
| launch-prep | Подготовка платформы к запуску — витрина, лаборатория, UX калькуляторов, чтение ссылок | in_progress | 2026-07-28 | 2026-07-28 |
| launch-p7-cheaper-leads | П7 «Найдём дешевле» — заявка с городом + диалог через служебный Telegram-бот | draft | 2026-07-28 | 2026-07-28 |
