...
|------|----------|--------|---------|---------|
| MASTER-zones-v6 | МЕТАПЛАН — свод №12 (комментарии владельца по галерее + аудит Кодекса): beam по гипотезам, контракт медиа, паспорт↔runtime, композитор по альтернативам, подача | in_progress | 2026-08-15 | 2026-08-15 |
