...
### Q8 — Окно: дистанции и что ставить у окна (В РАБОТЕ с 17.08; Codex — `_intake/codex-prompts/q8-window.answer.md`)
...
### Q9 — Приоры практики (частоты дизайнерских решений) — ПЛАН (Codex 18.08, `_intake/codex-prompts/q9-zone-priors.answer*.md`)
...
### Q10 — Приближение к практике: окно и угол (план по Codex 19.08, `_intake/codex-prompts/q10-close-gap.answer.md`)
