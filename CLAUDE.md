...
- **3. «Ремонт под ключ» — ПЛАТНО 9 900 ₽:** мебель + материалы + гайды + чертежи + смета (Renovation Cost Engine, не LLM) + **услуга живого дизайнера**. Замена дизайнера, но в 5–10× дешевле. Дизайнеры-B2B ~990 ₽/комната оптом.
