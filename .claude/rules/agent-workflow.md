...
- Владелец дал **постоянное разрешение на push + deploy**; отдельно не переспрашивать.
- Исключение — предупредить перед выкаткой, если она несёт особый риск (миграции, правки сервера/сети,
  необратимое). По умолчанию — катим.
